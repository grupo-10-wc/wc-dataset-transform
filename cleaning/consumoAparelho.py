...
def pdf_to_csv(pdf_path, csv_path="consumoAparelho.csv"):
    with pdfplumber.open(pdf_path) as pdf, open(csv_path, "w", newline="", encoding="utf-8") as csvfile:
        ...
        # Write header
        #writer.writerow(["Aparelho", "Potência (W)", "Dias/mês", "Uso/dia", "unidade", "Consumo mensal (kWh)"])
        ...
        for page in pdf.pages:
            ...
            for line in lines:
                ...
                if parts[0].isalpha() and len(parts) > 4 and parts[0].lower() != "consumo" and parts[-5].lower() != "frigobar":
                    ...
                    consumo = parts[-1]
                    #print([aparelho, potencia, dias, utilizacao, medida, consumo])
...
if __name__ == "__main__":
    ...
    pdf_to_csv(pdf_file)
    print("✅ PDF text extracted into CSV.")
